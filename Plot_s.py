...
import Windows.Диалоги.Диалог_трауктория
ai = [
...
class PlotCanvasData(FigureCanvas):
    ...
    def white(self):
        ...
        majorLocator   = FixedLocator(range(0,-200,-10))
